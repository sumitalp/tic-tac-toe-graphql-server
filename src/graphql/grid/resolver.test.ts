...
describe("Grid resolver", () => {
    ...
    describe("query", () => {
        ...
        it("should throw if no id is provided", () => {
            jest.spyOn(gridRepository, "findById").mockRejectedValue(
    ...
    describe("executeTurn", () => {
        it("should call placePlayer", async () => {
            ...
            jest.spyOn(gridRepository, "findById").mockResolvedValueOnce(
                testGrid
            );

            jest.spyOn(playerRepository, "findById").mockResolvedValueOnce(
                testPlayer
            );
            const params: any = {
                player: "NAUGHT",
        ...
        it("should throw if grid not found", async () => {
            jest.spyOn(gridRepository, "findById").mockResolvedValue(undefined);
